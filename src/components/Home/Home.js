    ...
    return (
        <Box>
            <Grid container direction="column" alignItems="stretch" className={classes.score}>
                <Grid item xs={12} sm={5}md={6} className={classes.root}>
                    <Typography variant="h2" className={`${classes.heading}`}>SCORE</Typography>
                    <Typography variant="h6" className={classes.iit}>IIT Roorkee</Typography>
            ...
            <Grid container direction="column" alignItems="stretch" className={classes.root1}>
